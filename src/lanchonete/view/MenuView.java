...
public class MenuView {
	...
	public void menu(UsuarioModel user) throws Exception {
		try {
			...
			do {
				...
				if (perfil == 2) {
					System.out.println("                  |     3 - Checar Pre�o de Mercadoria    |");
				}
				if (perfil == 1)
				...
				if (perfil == 1)
					System.out.println("                  |     4 - Gerenciamento de Usu�rios     |");
				if (perfil == 1)
	...
	private void MenuCliente() {
		...
		do {
			...
			System.out.println("                  |     6 - Hist�rico de Pedidos do cliente |");
	...
	private ProdutoModel getDadosProduto() throws ParseException {
		...
		System.out.println("Digite a data de validade(dd/mm/aaaa). Caso n�o tenha digite -");
		sc.nextLine();
	...
	private void MenuEstoque(UsuarioModel user) throws ParseException {
		...
		do {
			...
			System.out.println("                  |     6 - Definir n�vel para alerta de estoque baixo  |");
			System.out.println("                  |     0 - Voltar                                      |");
			System.out.println("                  =======================================================\n");
	...
	private UsuarioModel getDadosUser() throws ParseException {
		...
		System.out.println("Digite o perfil do usuario: 1-Propriet�rio / 2-Funcion�rio");
	...
	private void MenuUsuarios(UsuarioModel user) throws ParseException {
		...
		do {
			...
			System.out.println("                  |     5 - Pesquisar Usu�rio                           |");
			System.out.println("                  |     6 - Definir n�vel para alerta de estoque baixo  |");
			System.out.println("                  |     7 - Trocar senha                                |");
			System.out.println("                  |     8 - Trocar perfil de usu�rio                    |");
			System.out.println("                  |     0 - Voltar                                      |");
			System.out.println("                  =======================================================\n");
			...
			case 1:
				...
				if (returnSave > 0) {
					System.out.println("Usu�rio Cadastrado com sucesso.\n A senha de acesso � igual ao login.");
				} else {
			...
			case 3:
				...
				if (listaUpdate.size() > 0) {
					...
					if (returnUpdate > 0) {
						...
						System.out.println("Erro ao editar usu�rio...");
					}
				} else {
					System.out.println("C�digo inv�lido");
				}
			...
			case 7:
				...
				if (validaSenha == 0) {
					...
					if (!confirmaSenha.equals(novaSenha)) {
						System.out.println("Confirma��o de senha n�o confere");
					} else {
			...
			case 8:
				...
				if (listUser.size() > 0) {
					...
					if (returnUpdate > 0) {
						...
						System.out.println("Erro ao editar perfil do usu�rio...");
					}
				} else {
					System.out.println("C�digo inv�lido");
				}
	...
	public void RealizarPedido() {
		...
		/**
		 * Obtendo c�digo dos produtos do pedido
		 */
		int opcaoProdutos = 0;
		...
		do {
			...
			System.out.println("Deseja adicionar outro item? 1-Sim / 0-N�o");
			opcaoProdutos = sc.nextInt();
		} while (opcaoProdutos != 0);

		pedido.setProdutos(produtosPedido);
		/**
		 * Obtendo c�digo da mesa e checando se o mesmo � valido
		 */
		int continuaMesa = 0;
		...
		/**
		 * Obtendo c�digo do cliente e checando se o mesmo � valido
		 */
	...
	public void EncerrarPedido() {
		...
		if (pedido.size() > 0) {
			if (pedido.get(0).getStatus_pedido() == 1) {
				...
				System.out.println("Pedido " + codPedido + " j� encerrado.");
			}
		} else {
